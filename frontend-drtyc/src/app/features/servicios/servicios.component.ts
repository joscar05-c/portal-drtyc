    ...
    <div class="max-w-7xl mx-auto px-gutter py-space-xl">
      ...
      <div class="mb-space-lg">
        <div class="flex items-center gap-space-sm mb-space-xs">
          <span class="material-symbols-outlined text-[28px] text-primary">support_agent</span>
          <h1 class="text-headline-lg text-primary font-bold">Servicios y Tr&#225;mites</h1>
        </div>
        <p class="text-body-md text-on-surface-variant">
          Acceda a los servicios que ofrece la DRTC, tr&#225;mites en l&#237;nea, requisitos y procedimientos administrativos.
        </p>
      </div>
      ...
      <div class="bg-surface-container-lowest rounded-xl shadow-sm p-space-xl border border-outline-variant/30">
        <div class="flex flex-col items-center justify-center py-space-2xl text-center">
          ...
          <p class="text-body-sm text-on-surface-variant">Pr&#243;ximamente encontrar&#225; aqu&#237; el directorio de servicios y tr&#225;mites disponibles.</p>
        </div>
      </div>
    </div>
  `,
